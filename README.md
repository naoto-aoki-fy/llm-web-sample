...
`temperature` and `max_tokens` come from their dedicated inputs; and `thinking` comes
from the additional parameters JSON object. Additional parameter fields are merged
